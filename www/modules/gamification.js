...
function awardXP(amount, reason = '', sourceElement = null) {
    ...
    // 4. Записываем в DailyTracker (Gemini Sparks)
    if (typeof window.DailyTracker !== 'undefined' && window.DailyTracker.recordXPEarned) {
        window.DailyTracker.recordXPEarned(amount, reason);
    }

    // 5. Показываем плавающую анимацию XP
